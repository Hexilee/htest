...
func TestJSON_String(t *testing.T) {
	NewJSON([]byte(JSONAssertData), t).
		String("time", AssertDataTimeStr)
}
...
func TestJSON_Uint(t *testing.T) {
	NewJSON([]byte(JSONAssertData), t).
		Uint("number", uint64(1))
}

func TestJSON_Time(t *testing.T) {
	NewJSON([]byte(JSONAssertData), t).
		Time("time", AssertDataTime)
}

func TestJSON_Float(t *testing.T) {
	NewJSON([]byte(JSONAssertData), t).
		Float("number", float64(1))
}
